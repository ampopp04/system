/**
 * The <class>System.util.application.SessionMonitor</class> defines
 *  session related utilities. This monitors if we still have an active user
 *  session after a certain time period of inactivity.
 *
 * @author Andrew
 */
Ext.define('System.util.application.SessionMonitor', {
    ...
    window: Ext.create('Ext.window.Window', {
        ...
        buttons: [{
            ...
            handler: function () {
                System.util.application.UserUtils.heartBeat();
            }
        }, {
            text: 'Logout',
            action: 'logout',
