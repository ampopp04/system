...
Ext.define('System.util.system.UiComponentUtils', {
    ...
    statics: {
        ...
        retrieveComponentByAssignment: function (modelName, tableName, fkFieldId, componentTypeName, callbackImpl, scope) {
            ...
            System.util.data.StoreUtils.searchTableByModelNameAndParameters(modelName,
                ...
                function (records, operation, success, scope) {
                    callbackImpl(System.util.system.UiComponentUtils.convertUiComponentDataToJsConfig(records[0].getAssociatedData().uiComponent), scope);
                }, projection, scope);
        },
        ...
        convertUiComponentDefinitionDataToJs: function (uiComponentDefinitionData) {
            ...
            var uiComponent = uiComponentDefinitionData.getAssociatedData().uiComponent;
        ...
        convertUiComponentConfigDataToJsConfig: function (uiComponentConfig, jsonObject) {
            return System.util.system.UiComponentUtils.convertUiComponentConfigAttributeList(uiComponentConfig.uiComponentConfigAttributeList, jsonObject);
        },
