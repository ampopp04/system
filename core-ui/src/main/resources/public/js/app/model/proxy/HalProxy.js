...
Ext.define('System.model.proxy.HalProxy', {
    ...
    listeners: {
        ...
        exception: function (response, operation, eOpts) {
            // System.util.data.StoreUtils.lookupStore(this.model.$className).reload();
            System.util.application.ErrorUtils.dataRequestErrorCheck(false, operation.responseText, operation.status);
        }
    }
});