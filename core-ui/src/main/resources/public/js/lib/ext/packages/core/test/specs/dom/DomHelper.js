    ...
    function Ext_core_DomHelper_Tests() {
        ...
        describe("insertHtml", function () {
            ...
            describe("basic", function () {
                ...
                it("should insert a new element beforeBegin", function () {
                    dh.insertHtml('beforeBegin', testEl, HTML);
                });
                it("should insert a new element afterBegin", function () {
                    dh.insertHtml('afterBegin', testEl, HTML);
                });
                it("should insert a new element beforeEnd", function () {
                    dh.insertHtml('beforeEnd', testEl, HTML);
                });
                it("should insert a new element afterEnd", function () {
                    dh.insertHtml('afterEnd', testEl, HTML);
                });
                ...
                describe("textNode", function () {
                    ...
                    it("should insert a new element beforeBegin", function () {
                        dh.insertHtml('beforeBegin', textNode, HTML);
                    });
                    it("should insert a new element afterBegin", function () {
                        dh.insertHtml('afterBegin', textNode, HTML);
                    });
                    it("should insert a new element beforeEnd", function () {
                        dh.insertHtml('beforeEnd', textNode, HTML);
                    });
                    it("should insert a new element afterEnd", function () {
                        dh.insertHtml('afterEnd', textNode, HTML);
                    });
                });
