 ...
 *
 */
Ext.define('System.view.component.panel.grid.StatusBar', {
     ...
     *         title: 'StatusBar',
     *         // etc.
     *         bbar: Ext.create('System.view.component.panel.grid.StatusBar', {
     *             defaultText: 'Default status text',
     *             id: 'status-id',
     *             items: [{
     *                 text: 'A Button'
     ...
     *     var sb = Ext.create('System.view.component.panel.grid.StatusBar', {
     ...
     *
     * @return {System.view.component.panel.grid.StatusBar} this
     */
