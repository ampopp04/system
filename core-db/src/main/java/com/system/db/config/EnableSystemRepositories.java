...
/**
 * Overrides the {@link org.springframework.data.jpa.repository.config.EnableJpaRepositories}
 * such that we can replace it's bean @Import state with our own Import(SystemRepositoryDefinitionRegistrar.class)
 *
 * @author Andrew
 * @ see SystemRepositoryDefinitionRegistrar
...
@Documented
@Inherited
@Import(SystemRepositoryDefinitionRegistrar.class)
public @interface EnableSystemRepositories {
